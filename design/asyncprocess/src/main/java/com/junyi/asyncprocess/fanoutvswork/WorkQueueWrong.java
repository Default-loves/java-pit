...
public class WorkQueueWrong {
    ...
    /** when program start, use anonymous queue will generate different queue, it mean Instant A has QueueA and Instant B has QueueB,
     *  but the result we want is Instant A and Instant B link to the same Queue */
    @Bean
    public Queue queue() {
