...
/**
 * According to user input name, show the entire name. The same effect like auto complete
 * Avoid creating the same Object, it will lead to OOM
 */
@Service
@Slf4j
public class UsernameAutoCompleteService {
    ...
    public void wrong() {
        ...
        /** for each user name, like apple. Key "a" and "ap" point to different UserDTO(always new UserDTO), actually they should point to the same UserDTO */
