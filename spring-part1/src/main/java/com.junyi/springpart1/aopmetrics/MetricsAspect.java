...
//    @Pointcut("@annotation(com.junyi.spring.demo2.Metrics)")
//    public void withMetricsAnnotation() {
//    }

    @Pointcut("within(@com.junyi.springpart1.aopmetrics.Metrics *)")
    public void withMetricsAnnotation() {
    }
...
//    @Around("controllerBean()")
    public Object metrics(ProceedingJoinPoint pjp) throws Throwable {
        ...
        // get annotation from method first, otherwise from class
